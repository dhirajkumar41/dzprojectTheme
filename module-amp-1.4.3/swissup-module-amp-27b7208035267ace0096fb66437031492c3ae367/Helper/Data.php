...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->getConfig(self::XML_PATH_PRODUCT_TYPES);
    }
    ...
    public function getSupportedPages()
    {
        if ($this->getConfig(self::XML_PATH_ALL_PAGES)) {
            ...
            $pages = $this->getConfig(self::XML_PATH_PAGES);
    ...
    public function getRedirectTo(
        ...
        foreach ($response->getHeaders() as $header) {
            if (is_array($header) && $header['name'] === 'Location') {
                ...
                break;
            } else if (($header instanceof \Zend\Http\Header\HeaderInterface ||
                $header instanceof \Laminas\Http\Header\HeaderInterface) &&
